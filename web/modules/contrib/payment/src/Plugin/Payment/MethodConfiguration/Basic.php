...
class Basic extends PaymentMethodConfigurationBase implements ContainerFactoryPluginInterface {
  ...
  protected function getCapturePaymentStatusSelector(FormStateInterface $form_state) {
    $plugin_selector = $this->getPaymentStatusSelector($form_state, 'capture', $this->getCaptureStatusId());
  ...
  protected function getRefundPaymentStatusSelector(FormStateInterface $form_state) {
    $plugin_selector = $this->getPaymentStatusSelector($form_state, 'refund', $this->getRefundStatusId());
