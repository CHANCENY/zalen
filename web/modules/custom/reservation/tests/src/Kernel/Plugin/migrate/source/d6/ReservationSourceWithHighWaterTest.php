...
/**
 * Tests the Drupal 6 reservation source w/ high water handling.
 *
 * @covers \Drupal\reservation\Plugin\migrate\source\d6\Reservation
 *
 * @group reservation
 */
class ReservationSourceWithHighWaterTest extends MigrateSqlSourceTestBase {
  ...
  public function providerSource() {
    ...
    $tests[0]['high_water'] = $tests[0]['source_data']['reservations'][0]['timestamp'];
    return $tests;
  }
