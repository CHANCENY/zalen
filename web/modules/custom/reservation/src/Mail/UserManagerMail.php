...
final class UserManagerMail {
  ...
  public function send($accounts, $page, $reservation): bool {
    ...
    $subject = new TranslatableMarkup('Updated your reservation status in @site', ['@site' => $this->configFactory->get('system.site')->get('name'),]);
    $body = [
      'title' => [
        '#type' => 'html_tag',
        '#tag' => 'h2',
        '#value' => new TranslatableMarkup('Please check your reservation on the web site.'),
      ],
      'device' => [
        '#type' => 'html_tag',
        '#tag' => 'p',
        '#value' => new TranslatableMarkup('Please checkout on @checkout.', [
          '@checkout' => $reservation->checkout
        ]),
      ],
      'content' => [
        '#markup' => '<p style="font-size:inherit;font-weight:bold;color:#1e905d;text-decoration:none">' . new TranslatableMarkup('About reservation') . '</p>',
      ],
    ];
