 ...
 * @see plugin_api
 */
class HtmlMailManager extends DefaultPluginManager implements MailManagerInterface {
  ...
  public function getformat(array $message) {
  ...
  public function doMail($module, $key, $to, $langcode, $params = [], $reply = NULL, $send = TRUE) {
    ...
    // custom format
    $message = $this->getformat($message);
