...
class OrganizerInstanceConfirmation extends FormBase {
  ...
  public function getFormId(): string {
    return 'instance_confirmation_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $config = $this->configFactory->get('reservation.instance_booking_done_email');
    $template = $config->get('template_mail');
    $format = $config->get('template_mail_format');
    $form['field_wrapper'] = array(
      '#type' => 'details',
      '#title' => $this->t('Instance booking confirmation'),
      '#open' => TRUE,
    );
    $form['field_wrapper']['template'] = array(
      '#type' => 'text_format',
      '#title' => $this->t('Email for instance booking confirmation'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $config = $this->configFactory->getEditable('reservation.instance_booking_done_email');
