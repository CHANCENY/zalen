...
class CommissionInvoiceEmail extends FormBase {
  ...
  public function getFormId() {
    return "commission_subscription_email";
  }

  public function buildForm(array $form, FormStateInterface $form_state) {
    // Loading previous template saved.
    $config = $this->configFactory?->get('reservation.commission_invoice_email');
    $template = $config?->get('template_mail');
    $format = $config?->get('template_mail_format');
    $form['field_wrapper'] = array(
      '#type' => 'details',
      '#title' => $this->t('Commission Invoice Email to platform'),
      '#open' => FALSE,
    );
    $form['field_wrapper']['template'] = array(
      '#type' => 'text_format',
      '#title' => $this->t('Invoice Email to platform'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config = $this->configFactory->getEditable('reservation.commission_invoice_email');
