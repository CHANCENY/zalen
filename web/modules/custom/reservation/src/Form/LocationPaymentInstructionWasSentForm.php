...
/**
 * @class OrganizerConfirmationRequestForm to build mail for sending to organizer
 * on request for confirmation of booking.
 */
class LocationPaymentInstructionWasSentForm extends FormBase {
  ...
  public function getFormId(): string {
    return 'organizer_confirmation_request_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $config = $this->configFactory->get('reservation.notify_email_payment_instructions_sent');
    $template = $config->get('template_mail');
    $format = $config->get('template_mail_format');
    $form['field_wrapper'] = array(
      '#type' => 'details',
      '#title' => $this->t('Payment Instructions was sent'),
      '#open' => TRUE,
    );
    $form['field_wrapper']['template'] = array(
      '#type' => 'text_format',
      '#title' => $this->t('Notification email to location of payment instruction was sent'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $config = $this->configFactory->getEditable('reservation.notify_email_payment_instructions_sent');
