...
class OrganizerReservationCanceled extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $config = $this->configFactory->get('reservation.organizer_reservation_canceled');
    $template = $config->get('template_mail');
    $format = $config->get('template_mail_format');
    $form['field_wrapper'] = array(
      '#type' => 'details',
      '#title' => $this->t('Reservation Canceled'),
      '#open' => TRUE,
    );
    $form['field_wrapper']['template'] = array(
      '#type' => 'text_format',
      '#title' => $this->t('Email for organizer for reservation canceled '),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $config = $this->configFactory->getEditable('reservation.organizer_reservation_canceled');
