...
/**
 * @class ConfirmationEmailForm This is for building Email for a room owner whose
 * the room has a booking request.
 */

class LocationNotificationEmailForm extends FormBase {
  ...
  public function getFormId(): string {
    return 'reservation_confirmation_email_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $config = $this->configFactory->get('reservation.notify_email_of_booking_event');
    $template = $config->get('template_mail');
    $format = $config->get('template_mail_format');
    $form['field_wrapper'] = array(
      '#type' => 'details',
      '#title' => $this->t('Location notification email template of booking'),
      '#open' => FALSE,
    );
    $form['field_wrapper']['template'] = array(
      '#type' => 'text_format',
      '#title' => $this->t('Email for location'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $config = $this->configFactory->getEditable('reservation.notify_email_of_booking_event');
