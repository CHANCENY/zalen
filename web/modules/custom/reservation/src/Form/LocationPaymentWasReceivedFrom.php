...
class LocationPaymentWasReceivedFrom extends FormBase {
  ...
  public function getFormId(): string {
    return 'payment_was_received_from_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $config = $this->configFactory->get('reservation.notify_email_payment_received');
    $template = $config->get('template_mail');
    $format = $config->get('template_mail_format');
    $form['field_wrapper'] = array(
      '#type' => 'details',
      '#title' => $this->t('Location Payment received template'),
      '#open' => TRUE,
    );
    $form['field_wrapper']['template'] = array(
      '#type' => 'text_format',
      '#title' => $this->t('Notification email to location of payment received'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $config = $this->configFactory->getEditable('reservation.notify_email_payment_received');
