...
namespace Drupal\reservation\Plugin\views\argument;
 ...
 * user posted or reservationed on.
 *
 * @ingroup views_argument_handlers
 *
 * @ViewsArgument("argument_reservation_user_uid")
 */
class UserUid extends ArgumentPluginBase {
  ...
  /**
   * Constructs a \Drupal\reservation\Plugin\views\argument\UserUid object.
   *
  ...
  public function query($group_by = FALSE) {
    ...
    if ($this->table != 'reservation_field_data') {
      $subselect = $this->database->select('reservation_field_data', 'c');
