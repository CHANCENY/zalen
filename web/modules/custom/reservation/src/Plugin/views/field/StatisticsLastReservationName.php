...
/**
 * Field handler to present the name of the last reservation poster.
 *
 * @ingroup views_field_handlers
 *
 * @ViewsField("reservation_ces_last_reservation_name")
 */
class StatisticsLastReservationName extends FieldPluginBase {

  /**
   * {@inheritdoc}
   */
  public function query() {
    // last_reservation_name only contains data if the user is anonymous. So we
    ...
    $this->uid = $this->query->addField($this->tableAlias, 'last_reservation_uid');
  }
