...
namespace Drupal\reservation\Plugin\views\wizard;
...
/**
 * Tests creating reservation views with the wizard.
 *
 * @ViewsWizard(
 *   id = "reservation",
 *   base_table = "reservation_field_data",
 *   title = @Translation("Reservations")
 * )
 */
class Reservation extends WizardPluginBase {
  ...
  protected function rowStyleOptions() {
    $options = [];
    $options['entity:reservation'] = $this->t('reservations');
  ...
  protected function defaultDisplayOptions() {
    ...
    $display_options['access']['options']['perm'] = 'access reservations';

    // Add a relationship to nodes.
    $display_options['relationships']['node']['id'] = 'node';
    $display_options['relationships']['node']['table'] = 'reservation_field_data';
    $display_options['relationships']['node']['field'] = 'node';
    $display_options['relationships']['node']['entity_type'] = 'reservation_field_data';
    ...
    $display_options['fields']['subject']['table'] = 'reservation_field_data';
    $display_options['fields']['subject']['field'] = 'subject';
    $display_options['fields']['subject']['entity_type'] = 'reservation';
