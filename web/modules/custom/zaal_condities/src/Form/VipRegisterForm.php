...
/**
 * @file
 * Contains \Drupal\zaal_condities\Form\VipRegisterForm.
 */
...
/**
  * {@inheritdoc}.
  */
class VipRegisterForm extends AccountForm {

/**
 * {@inheritdoc}.
 */
  public function getFormId() {
    return 'vip_register_form';
  }
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    //['premium_zaal => VIP'];
//      $form['account']['roles']['#default_value'] = ['premium_zaal'];
    $form['account']['roles']['#default_value'] = ['magnus'];
    $form['field_betaling_accepteren_via_mo']['widget']['#required'] = TRUE;
   ...
   /**
    ...
    protected function actions(array $form, FormStateInterface $form_state) {
      ...
      $element['submit']['#value'] = $this->t('VIP account aanmaken');
...
//        ['query' => $destination]
//      );
      $pymt_mollie = $form_state->getValue('field_betaling_accepteren_via_mo')[0]['value'];
      if($pymt_mollie === 'ja'){
        $form_state->setRedirect(
          'payment_provider.oauth2_authorize_mollie',
          [],
          ['query' => ['q' => 'premium_zaal']]
        );
      }else{
        $form_state->setRedirect(
          'zaal_condities.capacity_selection'
        );
      }
